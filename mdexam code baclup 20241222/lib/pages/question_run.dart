                  ...
                  child: Column(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
/* Categorys */
                          Text(widget.userExam.categoryTitles(),
                              maxLines: 1,
...
/* Time */
                          widget.userExam.isShowTimeCounter
                              ? Row(
                                  children: [
                                    const Text(questionRunTimeTitle,
                                        maxLines: 1,
                                        style: TextStyle(
                                          color: Colors.black,
                                          fontSize: 15,
  ...
  String getHourMinutesSecond(DateTime datetime) {
    try {
      if (DateTime.now().toUtc().isAfter(datetime)) {
        ...
        seconds -= (int.parse(hour.toString().replaceAll(".0", "")).toInt() *
            (60 * 60));

        double minutes = (seconds / 60).truncateToDouble();

        seconds -=
            (int.parse(minutes.toString().replaceAll(".0", "")).toInt() * 60);
        return getHourMinuteSecondFormat(
                int.parse(hour.toString().replaceAll(".0", ""))) +
            ":" +
            getHourMinuteSecondFormat(
                int.parse(minutes.toString().replaceAll(".0", ""))) +
            ":" +
